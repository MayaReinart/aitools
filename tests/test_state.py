...
def test_get_state_not_found(state_store: StateStore, job_id: str) -> None:
...
def test_get_state_invalid_json(state_store: StateStore, job_id: str) -> None:
    """Test getting state with invalid JSON."""
    state_store.redis.get.return_value = b"invalid json"
    assert state_store.get_state(job_id) is None


def test_set_state(state_store: StateStore, job_id: str) -> None:
    """Test setting state."""
    state = TaskStateInfo(
        job_id=job_id,
...
def test_update_progress(state_store: StateStore, job_id: str) -> None:
...
def test_set_success(state_store: StateStore, job_id: str) -> None:
...
def test_set_failure(state_store: StateStore, job_id: str) -> None:
...
def test_set_retry(state_store: StateStore, job_id: str) -> None:
...
def test_state_persistence(state_store: StateStore, job_id: str) -> None:
